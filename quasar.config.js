...
module.exports = configure(function(ctx) {
  return {
    ...
    extras: [// 'ionicons-v4',
      "mdi-v5", "fontawesome-v6", // 'eva-icons',
      // 'themify',
      // 'line-awesome',
    ...
    devServer: {
      server: {
        type: "http"
      }, port: 8080, open: true // opens browser window automatically
    },
    ...
    pwa: {
      ...
      manifest: {
        ...
        description: `Custom gaming device configurator`,
        display: "standalone",
